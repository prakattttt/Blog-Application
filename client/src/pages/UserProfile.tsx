...
const UserProfile = () => {
  ...
  const user = {
    name: "John Doe",
    bio: "Frontend Developer | React Enthusiast | Building cool stuff with modern web technologies.",
            ...
            {data.posts.map((post) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <button className="mt-5 text-sm font-semibold text-black hover:underline">
                    Read More
                  </button>
                </div>
              </div>
